...
const { OrderPositionSchema, OrderPosition } = require('./orderposition.model');
...
function setupModels(sequelize) {
  ...
  OrderPosition.init(OrderPositionSchema, OrderPosition.config(sequelize));
  ...
  OrderPosition.associate(sequelize.models);
